...
func ParseStringPartialsRaw(data string, partials PartialProvider, forceRaw bool) (*Template, error) {
	tmpl := Template{data, oDelimiter, cDelimiter, 0, 1, []interface{}{}, forceRaw, partials}
	err := tmpl.parse()
...
// SetMustacheDelimiters sets the package wide un-exported variables of
// oDelimiter and cDelimiter to the corresponding string arguments. These
// will be used package wide whenever a Template is created.
func SetMustacheDelimiters(oD string, cD string) {
	oDelimiter = oD
	cDelimiter = cD
}

 func (tmpl *Template) ShowDelimiters() string {
 	return "" + tmpl.otag + "  |  " + tmpl.ctag
 }
...
func ParseFilePartialsRaw(filename string, forceRaw bool, partials PartialProvider) (*Template, error) {
	...
	tmpl := Template{string(data), oDelimiter, cDelimiter, 0, 1, []interface{}{}, forceRaw, partials}
	err = tmpl.parse()
